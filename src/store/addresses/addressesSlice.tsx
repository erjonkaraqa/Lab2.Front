...
export const updateAddress = createAsyncThunk('addresses/updateAddress', async ({ id, body }: updateAddressType, thunkAPI: any) => {
  try {
...
const addressesSlice = createSlice({
  ...
  extraReducers: (builder: any) => {
    builder
      ...
      .addCase(getAllAddresses.fulfilled, (state: initialStateTypes, action: any) => {
        state.loading = false
      ...
      .addCase(getAllAddresses.rejected, (state: initialStateTypes, action: any) => {
        state.loading = false
        state.success = false
        state.error = null
      ...
      .addCase(deleteAddress.fulfilled, (state: initialStateTypes, action: any) => {
        state.loading = false
        state.success = true
        state.error = null
      ...
      .addCase(deleteAddress.rejected, (state: initialStateTypes, action: any) => {
        state.loading = false
        state.success = false
        state.error = null
        state.message = 'Something went wrong. Please try againg later!'
      ...
      .addCase(createAddress.fulfilled, (state: initialStateTypes, action: any) => {
        state.loading = false
        state.success = true
        state.error = null
        state.message = 'Address was successfuly deleted'
      })
      .addCase(createAddress.rejected, (state: initialStateTypes, action: any) => {
        state.loading = false
        state.success = false
        state.error = null
        state.message = 'Something went wrong. Please try againg later!'
      ...
      .addCase(getAddressWithId.fulfilled, (state: initialStateTypes, action: any) => {
        state.loading = false
        state.success = true
      ...
      .addCase(getAddressWithId.rejected, (state: initialStateTypes, action: any) => {
        state.loading = false
        state.success = false
        state.error = null
        state.message = 'Something went wrong. Please try againg later!'
      ...
      .addCase(updateAddress.fulfilled, (state: initialStateTypes, action: any) => {
        state.loading = false
        state.success = true
        // state.address = action.payload
        state.error = null
      ...
      .addCase(updateAddress.rejected, (state: initialStateTypes, action: any) => {
        state.loading = false
        state.success = false
        state.error = null
        state.message = 'Something went wrong. Please try againg later!'
